...
export default function Card(props: CardProps){
    ...
    const { name, setState, setHoverState } = props
    const handleClick = () => {
        setState(name)

    const handleHover = () => {
            setHoverState(props.key)
    }
    }
     ...
     return (
        <>
            <div onMouseOver={() => setHoverState} className="hover:scale-110 transform transition duration-300 ease-in-out w-[20rem] h-[12rem] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
